...
//   At: 2024-05-31T23:06:53.5353259+03:00
//
...
public partial class NotifyServices
{
    ...
    ///<summary>Sends a notification message using the solar_off_notify service.</summary>
    public void SolarOffNotify(NotifySolarOffNotifyParameters data)
    {
        _haContext.CallService("notify", "solar_off_notify", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void SolarOffNotify(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "solar_off_notify", null, new NotifySolarOffNotifyParameters { Message = message, Title = title, Target = target, Data = data });
    }

    ///<summary>Sends a notification message using the solar_on_notify service.</summary>
    public void SolarOnNotify(NotifySolarOnNotifyParameters data)
    {
        _haContext.CallService("notify", "solar_on_notify", null, data);
    }
    ...
    ///<param name="target"> eg: platform specific</param>
    ///<param name="data"> eg: platform specific</param>
    public void SolarOnNotify(string message, string? title = null, object? target = null, object? data = null)
    {
        _haContext.CallService("notify", "solar_on_notify", null, new NotifySolarOnNotifyParameters { Message = message, Title = title, Target = target, Data = data });
    }
}
...
public partial record NotifySolarOffNotifyParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial record NotifySolarOnNotifyParameters
{
    ///<summary> eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
