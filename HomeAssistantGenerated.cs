...
//   At: 2024-10-15T14:50:52.1829321+03:00
//
...
public partial class MassServices
{
    ...
    ///<summary>Transfer the player&apos;s queue to another player.</summary>
    ///<param name="target">The target for this service call</param>
    ///<param name="sourcePlayer">he source media player which has the queue you want to transfer.</param>
    ///<param name="autoPlay">Start playing the queue on the target player. Omit to use the default behavior. eg: true</param>
    public void TransferQueue(ServiceTarget target, string sourcePlayer, bool? autoPlay = null)
    {
...
{
    ///<summary>he source media player which has the queue you want to transfer.</summary>
...
public static class MassEntityExtensionMethods
{
    ...
    ///<param name="sourcePlayer">he source media player which has the queue you want to transfer.</param>
    ///<param name="autoPlay">Start playing the queue on the target player. Omit to use the default behavior. eg: true</param>
    public static void TransferQueue(this IMediaPlayerEntityCore target, string sourcePlayer, bool? autoPlay = null)
    {
    ...
    ///<param name="sourcePlayer">he source media player which has the queue you want to transfer.</param>
    ///<param name="autoPlay">Start playing the queue on the target player. Omit to use the default behavior. eg: true</param>
    public static void TransferQueue(this IEnumerable<IMediaPlayerEntityCore> target, string sourcePlayer, bool? autoPlay = null)
    {
        target.CallService("transfer_queue", new MassTransferQueueParameters { SourcePlayer = sourcePlayer, AutoPlay = autoPlay });
    }
}
