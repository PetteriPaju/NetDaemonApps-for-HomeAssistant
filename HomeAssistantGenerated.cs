...
//   At: 2025-10-01T16:41:46.2495560+03:00
//
...
public partial class AutomationEntities
{
    ...
    ///<summary>AC off test</summary>
    public AutomationEntity AcOffTest => new(_haContext, "automation.ac_off_test");
    ...
    ///<summary>Blink Hallway light</summary>
    public AutomationEntity BlinkHallwayLight => new(_haContext, "automation.blink_hallway_light");
    ...
    ///<summary>End Recording and shutoff pc</summary>
    public AutomationEntity EndRecordingAndShutoffPc => new(_haContext, "automation.end_recording_and_shutoff_pc");
    ...
    ///<summary>Lower Audio During Night</summary>
    public AutomationEntity LowerAudioDuringNight => new(_haContext, "automation.lower_audio_during_night");
    ...
    ///<summary>Modem on for Nordpool</summary>
    public AutomationEntity ModemOnForNordpool2 => new(_haContext, "automation.modem_on_for_nordpool_2");
    ///<summary>Monitors off</summary>
    public AutomationEntity MonitorsOff => new(_haContext, "automation.monitors_off");
    ...
    ///<summary>Smart Speaker Toggle</summary>
    public AutomationEntity SmartSpeakerToggle => new(_haContext, "automation.smart_speaker_toggle");
    ///<summary>Solar Logging</summary>
    public AutomationEntity SolarLogging => new(_haContext, "automation.solar_logging");
    ///<summary>Speaker Controller</summary>
    public AutomationEntity SpeakerController => new(_haContext, "automation.speaker_controller");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Disk pve: One Touch HDD Health</summary>
    public BinarySensorEntity DiskPveOneTouchHddHealth => new(_haContext, "binary_sensor.disk_pve_one_touch_hdd_health");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Health</summary>
    public BinarySensorEntity DiskPveSamsungMz7ln128hchp000h1Health => new(_haContext, "binary_sensor.disk_pve_samsung_mz7ln128hchp_000h1_health");
    ///<summary>Disk pve: ST4000DM000-1F2168 Health</summary>
    public BinarySensorEntity DiskPveSt4000dm0001f2168Health => new(_haContext, "binary_sensor.disk_pve_st4000dm000_1f2168_health");
    ...
    ///<summary>Is Asleep Helper</summary>
    public BinarySensorEntity IsAsleepHelper => new(_haContext, "binary_sensor.is_asleep_helper");
    ///<summary>Is Day</summary>
    public BinarySensorEntity IsDay => new(_haContext, "binary_sensor.is_day");
    ...
    ///<summary>Kitchen  Power Active</summary>
    public BinarySensorEntity KitchenPowerActive => new(_haContext, "binary_sensor.kitchen_power_active");
    ...
    public BinarySensorEntity Lidl => new(_haContext, "binary_sensor.lidl");
    ...
    ///<summary>LivingRoomFP1 Occupancy</summary>
    ...
    public BinarySensorEntity Prisma => new(_haContext, "binary_sensor.prisma");
    ///<summary>QEMU haos14.0 (100) Health</summary>
    public BinarySensorEntity QemuHaos140100Health => new(_haContext, "binary_sensor.qemu_haos14_0_100_health");
    ///<summary>QEMU haos14.0 (100) Status</summary>
    public BinarySensorEntity QemuHaos140100Status => new(_haContext, "binary_sensor.qemu_haos14_0_100_status");
    ...
    public BinarySensorEntity SMarket => new(_haContext, "binary_sensor.s_market");
    ///<summary>Should Speaker be On</summary>
    public BinarySensorEntity ShouldSpeakerBeOn => new(_haContext, "binary_sensor.should_speaker_be_on");
    ...
    ///<summary>Solar Helper</summary>
    public BinarySensorEntity SolarHelper => new(_haContext, "binary_sensor.solar_helper");
    ...
    ///<summary>Walkingpad Contact Battery</summary>
    public BinarySensorEntity WalkingpadContactBatteryLow => new(_haContext, "binary_sensor.walkingpad_contact_battery_low");
    ///<summary>Walkingpad Contact Door</summary>
    public BinarySensorEntity WalkingpadContactContact => new(_haContext, "binary_sensor.walkingpad_contact_contact");
    ...
    ///<summary>Walkingpad Contact Tamper</summary>
    public BinarySensorEntity WalkingpadContactTamper => new(_haContext, "binary_sensor.walkingpad_contact_tamper");
...
public partial class ButtonEntities
{
    ...
    ///<summary>DESKTOP-K24V8NP Wake on LAN</summary>
    public ButtonEntity DesktopK24v8npWakeOnLan => new(_haContext, "button.desktop_k24v8np_wake_on_lan");
    ...
    ///<summary>Favorite current song</summary>
    public ButtonEntity OlohuoneNestFavoriteCurrentSong => new(_haContext, "button.olohuone_nest_favorite_current_song");
    ///<summary>Favorite current song</summary>
    public ButtonEntity OlohuoneNestFavoriteCurrentSong2 => new(_haContext, "button.olohuone_nest_favorite_current_song_2");
    ...
    ///<summary>PC endRecording</summary>
    public ButtonEntity PcEndrecording => new(_haContext, "button.pc_endrecording");
    ///<summary>PC Favorite current song</summary>
    public ButtonEntity PcFavoriteCurrentSong => new(_haContext, "button.pc_favorite_current_song");
    ...
    ///<summary>Favorite current song</summary>
    public ButtonEntity ThisDeviceFavoriteCurrentSong => new(_haContext, "button.this_device_favorite_current_song");
    ///<summary>VLC-TELNET Favorite current song</summary>
    public ButtonEntity VlcTelnetFavoriteCurrentSong => new(_haContext, "button.vlc_telnet_favorite_current_song");
    ///<summary>Walkingpad_Down</summary>
    public ButtonEntity WalkingpadDown => new(_haContext, "button.walkingpad_down");
    ///<summary>Walkingpad_Kill</summary>
    public ButtonEntity WalkingpadKill => new(_haContext, "button.walkingpad_kill");
    ///<summary>WalkingPad_Toggle</summary>
    public ButtonEntity WalkingpadToggle => new(_haContext, "button.walkingpad_toggle");
    ///<summary>Walkingpad_Up</summary>
    public ButtonEntity WalkingpadUp => new(_haContext, "button.walkingpad_up");
...
public partial class DeviceTrackerEntities
{
    ...
    ///<summary>DESKTOP-K24V8NP</summary>
    public DeviceTrackerEntity DesktopK24v8np2 => new(_haContext, "device_tracker.desktop_k24v8np_2");
    ...
    ///<summary>PC-98-E2-55-80-05-8D</summary>
    public DeviceTrackerEntity Pc192168028 => new(_haContext, "device_tracker.pc_192_168_0_28");
    ///<summary>PC-192-168-0-29</summary>
    public DeviceTrackerEntity Pc192168029 => new(_haContext, "device_tracker.pc_192_168_0_29");
    ///<summary>PC-48-F1-EB-E7-C9-2F</summary>
    public DeviceTrackerEntity Pc48F1EbE7C92f => new(_haContext, "device_tracker.pc_48_f1_eb_e7_c9_2f");
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>Actions On Sleep Disposable</summary>
    public InputBooleanEntity ActionsOnSleepDisposable => new(_haContext, "input_boolean.actions_on_sleep_disposable");
    ///<summary>Alarm Slot 1 Enabled</summary>
    public InputBooleanEntity AlarmS1Enabled => new(_haContext, "input_boolean.alarm_s1_enabled");
    ///<summary>Alarm Slot 1 Priority</summary>
    public InputBooleanEntity AlarmS1Priority => new(_haContext, "input_boolean.alarm_s1_priority");
    ///<summary>Alarm Slot 1 Repeat</summary>
    public InputBooleanEntity AlarmS1Repeat => new(_haContext, "input_boolean.alarm_s1_repeat");
    ///<summary>Alarm Slot 2 Enabled</summary>
    public InputBooleanEntity AlarmS2Enabled => new(_haContext, "input_boolean.alarm_s2_enabled");
    ///<summary>Alarm Slot 2 Priority</summary>
    public InputBooleanEntity AlarmS2Priority => new(_haContext, "input_boolean.alarm_s2_priority");
    ///<summary>Alarm Slot 2 Repeat</summary>
    public InputBooleanEntity AlarmS2Repeat => new(_haContext, "input_boolean.alarm_s2_repeat");
    ///<summary>Alarm Slot 3 Enabled</summary>
    public InputBooleanEntity AlarmS3Enabled => new(_haContext, "input_boolean.alarm_s3_enabled");
    ///<summary>Alarm Slot 3 Priority</summary>
    public InputBooleanEntity AlarmS3Priority => new(_haContext, "input_boolean.alarm_s3_priority");
    ///<summary>Alarm Slot 3 Repeat</summary>
    public InputBooleanEntity AlarmS3Repeat => new(_haContext, "input_boolean.alarm_s3_repeat");
    ///<summary>Alarm Slot 4 Enabled</summary>
    public InputBooleanEntity AlarmS4Enabled => new(_haContext, "input_boolean.alarm_s4_enabled");
    ///<summary>Alarm Slot 4 Priority</summary>
    public InputBooleanEntity AlarmS4Priority => new(_haContext, "input_boolean.alarm_s4_priority");
    ///<summary>Alarm Slot 4 Repeat</summary>
    public InputBooleanEntity AlarmS4Repeat => new(_haContext, "input_boolean.alarm_s4_repeat");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_a0gbl</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsA0gbl => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_a0gbl");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_easy_alarm</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsEasyAlarm => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_easy_alarm");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_is_home_manager</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsIsHomeManager => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_is_home_manager");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_lights_kitchen_light</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsLightsKitchenLight => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_lights_kitchen_light");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_lora_tap_bed</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsLoraTapBed => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_lora_tap_bed");
    ///<summary>dev_netdaemon_net_daemon_apps_apps_lora_tap_dekstop</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsLoraTapDekstop => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_lora_tap_dekstop");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_starkvind</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsStarkvind => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_starkvind");
    ...
    ///<summary>dev_netdaemon_net_daemon_apps_apps_treadmill_remote</summary>
    public InputBooleanEntity DevNetdaemonNetDaemonAppsAppsTreadmillRemote => new(_haContext, "input_boolean.dev_netdaemon_net_daemon_apps_apps_treadmill_remote");
    ...
    ///<summary>Lightgroup Livingroom Enabled</summary>
    public InputBooleanEntity LightgroupLivingroomEnabled => new(_haContext, "input_boolean.lightgroup_livingroom_enabled");
    ...
    ///<summary>netdaemon_net_daemon_apps_apps_easy_alarm</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsEasyAlarm => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_easy_alarm");
    ...
    ///<summary>netdaemon_net_daemon_apps_apps_treadmill_remote</summary>
    public InputBooleanEntity NetdaemonNetDaemonAppsAppsTreadmillRemote => new(_haContext, "input_boolean.netdaemon_net_daemon_apps_apps_treadmill_remote");
...
public partial class InputDatetimeEntities
{
    ...
    ///<summary>Alarm Slot 1 Time</summary>
    public InputDatetimeEntity AlarmS1Time => new(_haContext, "input_datetime.alarm_s1_time");
    ///<summary>Alarm Slot 2 Time</summary>
    public InputDatetimeEntity AlarmS2Time => new(_haContext, "input_datetime.alarm_s2_time");
    ///<summary>Alarm Slot 3 Time</summary>
    public InputDatetimeEntity AlarmS3Time => new(_haContext, "input_datetime.alarm_s3_time");
    ///<summary>Alarm Slot 4 Time</summary>
    public InputDatetimeEntity AlarmS4Time => new(_haContext, "input_datetime.alarm_s4_time");
...
public partial class InputNumberEntities
{
    ...
    ///<summary>Electricity-Calculator-Energy</summary>
    public InputNumberEntity ElectricityCalculatorEnergy => new(_haContext, "input_number.electricity_calculator_energy");
    ///<summary>Electricity-Calculator-Price</summary>
    public InputNumberEntity ElectricityCalculatorPrice => new(_haContext, "input_number.electricity_calculator_price");
    ...
    ///<summary>Volume At Day</summary>
    public InputNumberEntity VolumeAtDay => new(_haContext, "input_number.volume_at_day");
    ///<summary>Volume At Night</summary>
    public InputNumberEntity VolumeAtNight => new(_haContext, "input_number.volume_at_night");
...
public partial class InputSelectEntities
{
    ...
    ///<summary>Actions On Asleep</summary>
    public InputSelectEntity ActionsOnAsleep => new(_haContext, "input_select.actions_on_asleep");
    ...
    ///<summary>Debug_DropdownHelper</summary>
    public InputSelectEntity DebugDropdownhelper => new(_haContext, "input_select.debug_dropdownhelper");
    ...
    ///<summary>PC-Speaker-Mode</summary>
    public InputSelectEntity PcSpeakerMode => new(_haContext, "input_select.pc_speaker_mode");
    ///<summary>Phone Battery Alert Ranges</summary>
    public InputSelectEntity PhoneBatteryAlertRanges => new(_haContext, "input_select.phone_battery_alert_ranges");
    ...
    ///<summary>Smart Speaker Mode</summary>
    public InputSelectEntity SmartSpeakerMode => new(_haContext, "input_select.smart_speaker_mode");
...
public partial class InputTextEntities
{
    ...
    ///<summary>Alarm Slot 1 Message</summary>
    public InputTextEntity AlarmS1Message => new(_haContext, "input_text.alarm_s1_message");
    ///<summary>Alarm Slot 2 Message</summary>
    public InputTextEntity AlarmS2Message => new(_haContext, "input_text.alarm_s2_message");
    ///<summary>Alarm Slot 3 Message</summary>
    public InputTextEntity AlarmS3Message => new(_haContext, "input_text.alarm_s3_message");
    ///<summary>Alarm Slot 4 Message</summary>
    public InputTextEntity AlarmS4Message => new(_haContext, "input_text.alarm_s4_message");
...
public partial class MediaPlayerEntities
{
    ...
    public MediaPlayerEntity LocalMusicAssistantTelnet => new(_haContext, "media_player.local_music_assistant_telnet");
    public MediaPlayerEntity MusicAssistant => new(_haContext, "media_player.music_assistant");
    public MediaPlayerEntity MusicAssistant2 => new(_haContext, "media_player.music_assistant_2");
    ...
    ///<summary>PC</summary>
    public MediaPlayerEntity Pc2 => new(_haContext, "media_player.pc_2");
    ///<summary>VLC-TELNET</summary>
...
public partial class NumberEntities
{
    ...
    ///<summary>Ecoflow Output Plug Countdown</summary>
    public NumberEntity EcoflowOutputPlugCountdown => new(_haContext, "number.ecoflow_output_plug_countdown");
    ///<summary>Ecoflow Plug Countdown</summary>
    public NumberEntity EcoflowPlugCountdown => new(_haContext, "number.ecoflow_plug_countdown");
    ...
    ///<summary> USB-Multi-Fans Countdown l1</summary>
    public NumberEntity UsbMultiFansCountdownL1 => new(_haContext, "number.usb_multi_fans_countdown_l1");
    ///<summary> USB-Multi-Fans Countdown l2</summary>
    public NumberEntity UsbMultiFansCountdownL2 => new(_haContext, "number.usb_multi_fans_countdown_l2");
    ///<summary> USB-Multi-Fans Countdown l3</summary>
    public NumberEntity UsbMultiFansCountdownL3 => new(_haContext, "number.usb_multi_fans_countdown_l3");
}
...
public partial class ScriptEntities
{
    ...
    ///<summary>Clear All Playlists</summary>
    public ScriptEntity ClearAllPlaylists => new(_haContext, "script.clear_all_playlists");
    ...
    ///<summary>Restart NetDaemon</summary>
    public ScriptEntity RestartNetdaemon => new(_haContext, "script.restart_netdaemon");
    ///<summary>Retake Screentshot</summary>
    public ScriptEntity RetakeScreentshot => new(_haContext, "script.retake_screentshot");
...
public partial class SelectEntities
{
    ...
    ///<summary>Ecoflow Output Plug Indicator mode</summary>
    public SelectEntity EcoflowOutputPlugIndicatorMode => new(_haContext, "select.ecoflow_output_plug_indicator_mode");
    ///<summary>Ecoflow Output Plug Power outage memory</summary>
    public SelectEntity EcoflowOutputPlugPowerOutageMemory => new(_haContext, "select.ecoflow_output_plug_power_outage_memory");
    ///<summary>Ecoflow Plug Indicator mode</summary>
    public SelectEntity EcoflowPlugIndicatorMode => new(_haContext, "select.ecoflow_plug_indicator_mode");
    ///<summary>Ecoflow Plug Power outage memory</summary>
    public SelectEntity EcoflowPlugPowerOutageMemory => new(_haContext, "select.ecoflow_plug_power_outage_memory");
    ...
    ///<summary> USB-Multi-Fans Power-on behavior</summary>
    public SelectEntity UsbMultiFansPowerOnBehavior => new(_haContext, "select.usb_multi_fans_power_on_behavior");
...
public partial class SensorEntities
{
    ...
    ///<summary>Disk pve: One Touch HDD Node</summary>
    public SensorEntity DiskPveOneTouchHddNode => new(_haContext, "sensor.disk_pve_one_touch_hdd_node");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Node</summary>
    public SensorEntity DiskPveSamsungMz7ln128hchp000h1Node => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_node");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Power cycles</summary>
    public SensorEntity DiskPveSamsungMz7ln128hchp000h1PowerCycles => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_power_cycles");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Unexpected power loss</summary>
    public SensorEntity DiskPveSamsungMz7ln128hchp000h1UnexpectedPowerLoss => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_unexpected_power_loss");
    ///<summary>Disk pve: ST4000DM000-1F2168 Node</summary>
    public SensorEntity DiskPveSt4000dm0001f2168Node => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_node");
    ///<summary>Disk pve: ST4000DM000-1F2168 Power cycles</summary>
    public SensorEntity DiskPveSt4000dm0001f2168PowerCycles => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_power_cycles");
    ///<summary>Ecoflow Ac Input Quarter</summary>
    public SensorEntity EcoflowAcInputQuarter => new(_haContext, "sensor.ecoflow_ac_input_quarter");
    ...
    ///<summary>Ecoflow Solar Input Quarter</summary>
    public SensorEntity EcoflowSolarInputQuarter => new(_haContext, "sensor.ecoflow_solar_input_quarter");
    ///<summary>Ecoflow Status</summary>
    public SensorEntity EcoflowStatus => new(_haContext, "sensor.ecoflow_status");
    ///<summary>Energy Eco Out Hourly</summary>
    public SensorEntity EnergyEcoOutHourly => new(_haContext, "sensor.energy_eco_out_hourly");
    ...
    public SensorEntity NodePveLastBoot => new(_haContext, "sensor.node_pve_last_boot");
    ...
    ///<summary>PC DISPLAY5</summary>
    public SensorEntity PcC2ce45413a854b03Aacc016f116bc0fdDisplay5 => new(_haContext, "sensor.pc_c2ce4541_3a85_4b03_aacc_016f116bc0fd_display5");
    ...
    public SensorEntity QemuHaos140100LastBoot => new(_haContext, "sensor.qemu_haos14_0_100_last_boot");
    ///<summary>QEMU haos14.0 (100) Node</summary>
    public SensorEntity QemuHaos140100Node => new(_haContext, "sensor.qemu_haos14_0_100_node");
    ///<summary>QEMU haos14.0 (100) Status</summary>
    public SensorEntity QemuHaos140100Status => new(_haContext, "sensor.qemu_haos14_0_100_status");
    ...
    ///<summary>All Powers energy quarter-hourly</summary>
    public NumericSensorEntity AllPowersEnergyQuarterHourly => new(_haContext, "sensor.all_powers_energy_quarter_hourly");
    ...
    ///<summary>Disk pve: One Touch HDD Size</summary>
    public NumericSensorEntity DiskPveOneTouchHddSize => new(_haContext, "sensor.disk_pve_one_touch_hdd_size");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Airflow temperature</summary>
    public NumericSensorEntity DiskPveSamsungMz7ln128hchp000h1AirflowTemperature => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_airflow_temperature");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Power-on hours</summary>
    public NumericSensorEntity DiskPveSamsungMz7ln128hchp000h1PowerOnHours => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_power_on_hours");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Size</summary>
    public NumericSensorEntity DiskPveSamsungMz7ln128hchp000h1Size => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_size");
    ///<summary>Disk pve: SAMSUNG MZ7LN128HCHP-000H1 Wearout</summary>
    public NumericSensorEntity DiskPveSamsungMz7ln128hchp000h1Wearout => new(_haContext, "sensor.disk_pve_samsung_mz7ln128hchp_000h1_wearout");
    ///<summary>Disk pve: ST4000DM000-1F2168 Airflow temperature</summary>
    public NumericSensorEntity DiskPveSt4000dm0001f2168AirflowTemperature => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_airflow_temperature");
    ///<summary>Disk pve: ST4000DM000-1F2168 Power-on hours</summary>
    public NumericSensorEntity DiskPveSt4000dm0001f2168PowerOnHours => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_power_on_hours");
    ///<summary>Disk pve: ST4000DM000-1F2168 Size</summary>
    public NumericSensorEntity DiskPveSt4000dm0001f2168Size => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_size");
    ///<summary>Disk pve: ST4000DM000-1F2168 Temperature</summary>
    public NumericSensorEntity DiskPveSt4000dm0001f2168Temperature => new(_haContext, "sensor.disk_pve_st4000dm000_1f2168_temperature");
    ...
    ///<summary>Ecoflow AC Output Quarter</summary>
    public NumericSensorEntity EcoflowAcOutputQuarter => new(_haContext, "sensor.ecoflow_ac_output_quarter");
    ...
    ///<summary>Ecoflow Cost This Hour</summary>
    public NumericSensorEntity EcoflowCostThisHour => new(_haContext, "sensor.ecoflow_cost_this_hour");
    ...
    ///<summary>Ecoflow Fortum This Hour</summary>
    public NumericSensorEntity EcoflowFortumThisHour => new(_haContext, "sensor.ecoflow_fortum_this_hour");
    ...
    ///<summary>Ecoflow Output Plug Energy</summary>
    public NumericSensorEntity EcoflowOutputPlugEnergy => new(_haContext, "sensor.ecoflow_output_plug_energy");
    ///<summary>Ecoflow Output Plug Power</summary>
    public NumericSensorEntity EcoflowOutputPlugPower => new(_haContext, "sensor.ecoflow_output_plug_power");
    ///<summary>Ecoflow Plug Current</summary>
    public NumericSensorEntity EcoflowPlugCurrent => new(_haContext, "sensor.ecoflow_plug_current");
    ///<summary>Ecoflow Plug Energy</summary>
    public NumericSensorEntity EcoflowPlugEnergy => new(_haContext, "sensor.ecoflow_plug_energy");
    ///<summary>Ecoflow Plug Power</summary>
    public NumericSensorEntity EcoflowPlugPower => new(_haContext, "sensor.ecoflow_plug_power");
    ///<summary>Ecoflow Plug Voltage</summary>
    public NumericSensorEntity EcoflowPlugVoltage => new(_haContext, "sensor.ecoflow_plug_voltage");
    ...
    ///<summary>Ecoflow Total In  Energy</summary>
    public NumericSensorEntity EcoflowTotalInEnergy => new(_haContext, "sensor.ecoflow_total_in_energy");
    ...
    ///<summary>Ecoflow Total Out  Energy</summary>
    public NumericSensorEntity EcoflowTotalOutEnergy => new(_haContext, "sensor.ecoflow_total_out_energy");
    ...
    ///<summary>Ecoflow Transfer This Hour</summary>
    public NumericSensorEntity EcoflowTransferThisHour => new(_haContext, "sensor.ecoflow_transfer_this_hour");
    ...
    ///<summary>Energy Cost This Hour</summary>
    public NumericSensorEntity EnergyCostThisHour => new(_haContext, "sensor.energy_cost_this_hour");
    ///<summary>Energy Fortum This Hour</summary>
    public NumericSensorEntity EnergyFortumThisHour => new(_haContext, "sensor.energy_fortum_this_hour");
    ///<summary>Energy Hourly Eco Adjusted</summary>
    public NumericSensorEntity EnergyHourlyEcoAdjusted => new(_haContext, "sensor.energy_hourly_eco_adjusted");
    ///<summary>Energy Transfer This Hour</summary>
    public NumericSensorEntity EnergyTransferThisHour => new(_haContext, "sensor.energy_transfer_this_hour");
    ...
    ///<summary>nordpool_kwh_fi_eur_3_10_0</summary>
    ...
    public NumericSensorEntity OutsideTemperatureMeterIlluminance => new(_haContext, "sensor.outside_temperature_meter_illuminance");
    ...
    public NumericSensorEntity QemuHaos140100CpuUsed => new(_haContext, "sensor.qemu_haos14_0_100_cpu_used");
    ///<summary>QEMU haos14.0 (100) Disk used percentage</summary>
    public NumericSensorEntity QemuHaos140100DiskUsedPercentage => new(_haContext, "sensor.qemu_haos14_0_100_disk_used_percentage");
    ///<summary>QEMU haos14.0 (100) Memory free</summary>
    public NumericSensorEntity QemuHaos140100MemoryFree => new(_haContext, "sensor.qemu_haos14_0_100_memory_free");
    ///<summary>QEMU haos14.0 (100) Memory used</summary>
    public NumericSensorEntity QemuHaos140100MemoryUsed => new(_haContext, "sensor.qemu_haos14_0_100_memory_used");
    ///<summary>QEMU haos14.0 (100) Memory used percentage</summary>
    public NumericSensorEntity QemuHaos140100MemoryUsedPercentage => new(_haContext, "sensor.qemu_haos14_0_100_memory_used_percentage");
    ...
    ///<summary>Starkvind energy</summary>
    public NumericSensorEntity StarkvindEnergy => new(_haContext, "sensor.starkvind_energy");
    ...
    ///<summary>Starkvind power</summary>
    public NumericSensorEntity StarkvindPower => new(_haContext, "sensor.starkvind_power");
    ///<summary>Statistical characteristic</summary>
    public NumericSensorEntity StatisticalCharacteristic => new(_haContext, "sensor.statistical_characteristic");
    ...
    ///<summary>VLC-Volume</summary>
    public NumericSensorEntity VlcVolume => new(_haContext, "sensor.vlc_volume");
    ///<summary>Walkingpad Contact Battery</summary>
    public NumericSensorEntity WalkingpadContactBattery => new(_haContext, "sensor.walkingpad_contact_battery");
...
public partial class SwitchEntities
{
    ...
    ///<summary>AC Internet Access</summary>
    ...
    ///<summary>DESKTOP-K24V8NP Internet Access</summary>
    public SwitchEntity DesktopK24v8npInternetAccess2 => new(_haContext, "switch.desktop_k24v8np_internet_access_2");
    ...
    ///<summary>Ecoflow Output Plug</summary>
    public SwitchEntity EcoflowOutputPlug => new(_haContext, "switch.ecoflow_output_plug");
    ///<summary>Ecoflow Output Plug Child lock</summary>
    public SwitchEntity EcoflowOutputPlugChildLock => new(_haContext, "switch.ecoflow_output_plug_child_lock");
    ///<summary>Ecoflow Plug</summary>
    public SwitchEntity EcoflowPlug => new(_haContext, "switch.ecoflow_plug");
    ///<summary>Ecoflow Plug Child lock</summary>
    public SwitchEntity EcoflowPlugChildLock => new(_haContext, "switch.ecoflow_plug_child_lock");
    ...
    ///<summary>FRITZ!Box 6660 Cable Port forward HTTPS-Server 443</summary>
    public SwitchEntity FritzBox6660CablePortForwardHttpsServer443 => new(_haContext, "switch.fritz_box_6660_cable_port_forward_https_server_443");
    ...
    ///<summary>Hue Plug</summary>
    public SwitchEntity HuePlug => new(_haContext, "switch.hue_plug");
    ...
    ///<summary>PC-98-E2-55-80-05-8D Internet Access</summary>
    public SwitchEntity Pc192168028InternetAccess => new(_haContext, "switch.pc_192_168_0_28_internet_access");
    ///<summary>PC-192-168-0-29 Internet Access</summary>
    public SwitchEntity Pc192168029InternetAccess => new(_haContext, "switch.pc_192_168_0_29_internet_access");
    ///<summary>PC-48-F1-EB-E7-C9-2F Internet Access</summary>
    public SwitchEntity Pc48F1EbE7C92fInternetAccess => new(_haContext, "switch.pc_48_f1_eb_e7_c9_2f_internet_access");
    ...
    ///<summary>Schedule #577ee5</summary>
    public SwitchEntity Schedule577ee5 => new(_haContext, "switch.schedule_577ee5");
    ...
    ///<summary>Schedule #f3cb6e</summary>
    public SwitchEntity ScheduleF3cb6e => new(_haContext, "switch.schedule_f3cb6e");
    ...
    ///<summary>Desk Fan Bottom</summary>
    public SwitchEntity UsbMultiFansL1 => new(_haContext, "switch.usb_multi_fans_l1");
    ///<summary>Desk Fan Top</summary>
    public SwitchEntity UsbMultiFansL2 => new(_haContext, "switch.usb_multi_fans_l2");
    ///<summary> USB-Multi-Fans L3</summary>
    public SwitchEntity UsbMultiFansL3 => new(_haContext, "switch.usb_multi_fans_l3");
...
public partial class UpdateEntities
{
    ...
    ///<summary>Ecoflow Output Plug</summary>
    public UpdateEntity EcoflowOutputPlug => new(_haContext, "update.ecoflow_output_plug");
    ///<summary>Ecoflow Plug</summary>
    ...
    ///<summary>Hue Plug</summary>
    public UpdateEntity HuePlug => new(_haContext, "update.hue_plug");
...
public partial class InputButtonEntities
{
    ...
    ///<summary>Debug_Energy_HourlyUpdate</summary>
    public InputButtonEntity DebugEnergyHourlyupdate => new(_haContext, "input_button.debug_energy_hourlyupdate");
    ///<summary>Debug_Energy_ReadForecast</summary>
    public InputButtonEntity DebugEnergyReadforecast => new(_haContext, "input_button.debug_energy_readforecast");
...
public partial class AssistSatelliteServices
{
    ...
    public void AskQuestion(string entityId, string? question = null, object? questionMediaId = null, bool? preannounce = null, object? preannounceMediaId = null, object? answers = null)
    {
...
public partial record AssistSatelliteAskQuestionParameters
{
    ...
    public object? Answers { get; init; }
}
...
public partial class ScriptServices
{
    ...
    {
        _haContext.CallService("script", "clear_all_playlists", null);
    }
    ...
    public void RestartNetdaemon()
    {
        _haContext.CallService("script", "restart_netdaemon", null);
    }

    public void RetakeScreentshot()
    {
        _haContext.CallService("script", "retake_screentshot", null);
    }
